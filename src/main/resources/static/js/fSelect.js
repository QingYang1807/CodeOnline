(function($) {
    ...
    $.fn.fSelect = function(options) {
        ...
        fSelect.prototype = {
            create: function() {
                var multiple = this.$select.is('[multiple]') ? ' multiple' : 'multiple';
                this.$select.wrap('<div id="select_drop" class="fs-wrap' + multiple + '"></div>');
                this.$select.before('<div class="fs-label-wrap"><div class="fs-label" onchange="addCodeOfLanguage()">' + this.settings.placeholder + '</div><span class="fs-arrow"></span></div>');
